...
*/
SOCKET tcp_nb_connect(char * dsthost, int dstport, char * localip, int localport, int * consucc)
{
	SOCKET fd;
	int ret;
	struct sockaddr_in cli; 
...
*/
SOCKET tcp_nb_connect2(struct in_addr dstip, int dstport, char * localip, int localport, int *consucc)
{
	SOCKET fd;
	int ret;
	int err;
...
struct in_addr sock_get_hostip (char *host)
{
