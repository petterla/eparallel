...
SOCKET tcp_connect2 (struct in_addr dstip, int dstport, char * localip, int localport);


SOCKET tcp_nb_connect (char * dsthost, int dstport, 
                       char * localip, int localport, int * consucc);
